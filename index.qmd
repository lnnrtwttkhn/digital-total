...
**Boosting digital and data literacy in *students* and *teachers***

## Teaching: Version Control of Code and Data
...
- **Interoperable:** Use commonly used formats (e.g., PowerPoint) or plain-text open formats (e.g., Markdown)
- **Reusable:** Add documentation, metadata and share under an open license (e.g., Creative Commons licenses)

::: {.fragment}
::: {style="font-size: 70%;"}
For details, also see @plomp2023 (via [Digital Research Academy](https://digital-research.academy/))
:::
:::
