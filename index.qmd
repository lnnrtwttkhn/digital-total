...
:::: {.column width="50%"}
::: {.fragment}
*"... when the **same analysis** steps performed on the **same dataset** consistently produce the **same answer**."* ^[@turingway2022, see chapter on ["Reproducible Research"](https://the-turing-way.netlify.app/reproducible-research/overview/overview-definitions)]

![by [Scriberia]({{< var links.scriberia >}}) for @turingway2022 ([Link](https://zenodo.org/record/3678226/files/ReproducibleDefinitionGrid.jpg), [CC BY
...
- 90% of researchers: "reproducibility crisis" (*N* = 1576) ^[see @baker2016]
